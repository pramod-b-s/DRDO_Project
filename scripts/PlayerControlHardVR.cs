...
public class PlayerControlHardVR : MonoBehaviour
{
    ...
    void Start()
    {
		...
		sw = new StreamWriter(Application.persistentDataPath+"/datalogHard.txt", true);
    ...
    private void OnDestroy()
    {
        ...
        using (sw)
        {
            ...
            if (health1 <= 0)
            {
                ...
                sw.WriteLine("at position " + AggressiveEnemy1HardVR.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy1HardVR.DestroyedAtTime);
            }
            else
            {
            ...
            if (health2 <= 0)
            {
                ...
                sw.WriteLine("at position " + AggressiveEnemy2HardVR.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy2HardVR.DestroyedAtTime);
            }
            else
            {
            ...
            if (health3 <= 0)
            {
                ...
                sw.WriteLine("at position " + AggressiveEnemy3HardVR.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy3HardVR.DestroyedAtTime);
            }
            else
            {
            ...
            if (healthHQ3 <= 0)
            {
                ...
                sw.WriteLine("at position " + AggressiveEnemy4HardVR.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy4HardVR.DestroyedAtTime);
            }
            else
            {
                sw.WriteLine("Submarine 4 destroyed ");
            ...
            if (healthHQ1 <= 0)
            {
                ...
                sw.WriteLine("at position " + HQAttackingEnemy1HardVR.DestroyedAtPosIsl);
                sw.WriteLine("at time " + HQAttackingEnemy1HardVR.DestroyedAtPosIsl);
            }
            else
            {
                sw.WriteLine("Submarine at HQ 1 destroyed ");
            ...
            if (healthHQ2 <= 0)
            {
                ...
                sw.WriteLine("at position " + HQAttackingEnemy2HardVR.DestroyedAtPosIsl);
                sw.WriteLine("at time " + HQAttackingEnemy2HardVR.DestroyedAtPosIsl);
            }
            else
            {
                sw.WriteLine("Submarine at HQ 2 destroyed ");
