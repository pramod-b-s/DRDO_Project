...
public class HQAttackingEnemy1 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (PlayerControlEasy.Enemy1IslandHit == 1 && flag == 0)
        {
            gobackflag = 0;
        ...
        if (flag == 1)
        {
            if (Time.time >= nextTime)
            {
                ...
                gobackflag = 1;
                PlayerControlEasy.Enemy1IslandHit = 0;
        ...
        {
            HQEnemy.AddForce(new Vector3(0, -50000, 0), ForceMode.Force);
