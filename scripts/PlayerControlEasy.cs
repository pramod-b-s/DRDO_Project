...
public class PlayerControlEasy : MonoBehaviour
{
    ...
    private int ctrlFlag = 0, winFlag = 0, disorientflag = 0, fileCreationFlag = 0;
    ...
    void Start()
    {
        ...
        if (!File.Exists("datalogEasy.txt"))
        {
            fileCreationFlag = 1;
        }
        ...
        //Application.persistentDataPath
        sw = new StreamWriter("datalogEasy.txt", true);
    ...
    private void FixedUpdate()
    {
        ...
        if (e1.transform.eulerAngles.x != 90)
        {
            warningtxt.text = "Enemy destroyed by collision !!";
            health1 = 0;
            health1txt.text = "";
            nextTime = Time.time + diff;
        }
        if (e2.transform.eulerAngles.x != 90)
        {
            warningtxt.text = "Enemy destroyed by collision !!";
            health2 = 0;
            health2txt.text = "";
        ...
        if (e3.transform.eulerAngles.x != 90)
        {
            warningtxt.text = "Enemy destroyed by collision !!";
            health3 = 0;
            health3txt.text = "";
        ...
        if (eHQ1.transform.eulerAngles.x != 90)
        {
            warningtxt.text = "Enemy destroyed by collision !!";
            healthHQ1 = 0;
            healthIsland1txt.text = "";
        ...
        if (eHQ2.transform.eulerAngles.x != 90)
        {
            warningtxt.text = "Enemy destroyed by collision !!";
            healthHQ2 = 0;
            healthIsland2txt.text = "";
        ...
        if (eHQ3.transform.eulerAngles.x != 90)
        {
            warningtxt.text = "Enemy destroyed by collision !!";
            healthHQ3 = 0;
            healthIsland3txt.text = "";
    ...
    private void OnDestroy()
    {
        ...
        dt.Columns.Add("hits");
        dt.Columns.Add("shots");
        dt.Columns.Add("accuracy");
        dt.Columns.Add("health");

        dt.Columns.Add("P_pos");
        dt.Columns.Add("P_time");

        dt.Columns.Add("PHQ1_pos");
        dt.Columns.Add("PHQ1_time");

        dt.Columns.Add("PHQ2_pos");
        dt.Columns.Add("PHQ2_time");

        dt.Columns.Add("PHQ3_pos");
        dt.Columns.Add("PHQ3_time");
    
        dt.Columns.Add("PHQ4_pos");
        dt.Columns.Add("PHQ4_time");

        dt.Columns.Add("P1_pos");
        dt.Columns.Add("P1_time");

        dt.Columns.Add("P2_pos");
        dt.Columns.Add("P2_time");

        dt.Rows.Add("subject " + (dt.Rows.Count + 1));

        using (sw)
        {
            if (fileCreationFlag == 1)
            {
                sw.Write("H\tS\t%H\tHLTH\tPpos\t\tPtime\tEHQ1pos\t\tEHQ1t\tEHQ2pos\t\tEHQ2t\tEHQ3pos\t\tEHQ3t\t" +
                    "EHQ4pos\t\tEHQ4t\tE1pos\t\tE1t\tE2pos\t\tE2t");
                sw.WriteLine("");
            }


            dt.Rows[dt.Rows.Count - 1]["hits"] = hits;
            dt.Rows[dt.Rows.Count - 1]["shots"] = shots;

            if (shots == 0)
            {
                dt.Rows[dt.Rows.Count - 1]["accuracy"] = 0;
            }
            else
            {
                dt.Rows[dt.Rows.Count - 1]["accuracy"] = hits/shots;
            }

            dt.Rows[dt.Rows.Count - 1]["health"] = health;

            if (health <= 0)
            {
                dt.Rows[dt.Rows.Count - 1]["P_pos"] = transform.position;
                dt.Rows[dt.Rows.Count - 1]["P_time"] = var;
            }
            else
            {
                dt.Rows[dt.Rows.Count - 1]["P_pos"] = 0;
                dt.Rows[dt.Rows.Count - 1]["P_time"] = 0;
            }

            if (health2 <= 0)
            {
                dt.Rows[dt.Rows.Count - 1]["P1_pos"] = AggressiveEnemy2Easy.DestroyedAtPos.ToString();
                dt.Rows[dt.Rows.Count - 1]["P1_time"] = AggressiveEnemy2Easy.DestroyedAtTime.ToString();
            }
            else
            {
                dt.Rows[dt.Rows.Count - 1]["P1_pos"] = AggressiveEnemy2Easy.DestroyedAtPos.ToString();
            ...
            if (health3 <= 0)
            {
                dt.Rows[dt.Rows.Count - 1]["P2_pos"] = AggressiveEnemy3Easy.DestroyedAtPos.ToString();
                dt.Rows[dt.Rows.Count - 1]["P2_time"] = AggressiveEnemy3Easy.DestroyedAtTime.ToString();
            }
            else
            {
                dt.Rows[dt.Rows.Count - 1]["P2_pos"] = AggressiveEnemy3Easy.DestroyedAtPos.ToString();
            ...
            if (healthHQ1 <= 0)
            {
                dt.Rows[dt.Rows.Count - 1]["PHQ1_pos"] = HQAttackingEnemy1Easy.DestroyedAtPosIsl.ToString();
                dt.Rows[dt.Rows.Count - 1]["PHQ1_time"] = HQAttackingEnemy1Easy.DestroyedAtTimeIsl.ToString();
            }
            else
            {
                dt.Rows[dt.Rows.Count - 1]["PHQ1_pos"] = HQAttackingEnemy1Easy.DestroyedAtPosIsl.ToString();
            ...
            if (healthHQ2 <= 0)
            {
                dt.Rows[dt.Rows.Count - 1]["PHQ2_pos"] = HQAttackingEnemy2Easy.DestroyedAtPosIsl.ToString();
                dt.Rows[dt.Rows.Count - 1]["PHQ2_time"] = HQAttackingEnemy2Easy.DestroyedAtTimeIsl.ToString();
            }
            else
            {
                dt.Rows[dt.Rows.Count - 1]["PHQ2_pos"] = HQAttackingEnemy2Easy.DestroyedAtPosIsl.ToString();
            ...
            if (healthHQ3 <= 0)
            {
                dt.Rows[dt.Rows.Count - 1]["PHQ3_pos"] = HQAttackingEnemy3Easy.DestroyedAtPosIsl.ToString();
                dt.Rows[dt.Rows.Count - 1]["PHQ3_time"] = HQAttackingEnemy3Easy.DestroyedAtTimeIsl.ToString();
            }
            else
            {
                dt.Rows[dt.Rows.Count - 1]["PHQ3_pos"] = HQAttackingEnemy3Easy.DestroyedAtPosIsl.ToString();
            ...
            if (health1 <= 0)
            {
                dt.Rows[dt.Rows.Count - 1]["PHQ4_pos"] = HQAttackingEnemy4Easy.DestroyedAtPosIsl.ToString();
                dt.Rows[dt.Rows.Count - 1]["PHQ4_time"] = HQAttackingEnemy4Easy.DestroyedAtTimeIsl.ToString();
            }
            else
            {
                dt.Rows[dt.Rows.Count - 1]["PHQ4_pos"] = HQAttackingEnemy4Easy.DestroyedAtPosIsl.ToString();
            ...
            sw.Write(dt.Rows[dt.Rows.Count - 1]["hits"]);
            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["shots"]);

            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["accuracy"]);
            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["health"]);

            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["P_pos"] + "\t");
            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["P_time"]);

            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["PHQ1_pos"] + "\t");
            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["PHQ1_time"]);

            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["PHQ2_pos"] + "\t");
            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["PHQ2_time"]);

            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["PHQ3_pos"] + "\t");
            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["PHQ3_time"]);

            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["PHQ4_pos"]);
            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["PHQ4_time"]);

            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["P1_pos"]);
            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["P1_time"]);

            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["P2_pos"]);
            sw.Write("\t" + dt.Rows[dt.Rows.Count - 1]["P2_time"]);
        ...
        /*using (sw)
        {
            ...
            sw.WriteLine("Health remaining : " + health);
            sw.WriteLine("");
            ...
            if (health <= 0)
            {
                ...
                if (disorientflag == 0)
                {
                    sw.WriteLine("because of being shot down by enemy submarines");
                }
            ...
            if (health2 <= 0)
            {
                ...
                sw.WriteLine("at position " + AggressiveEnemy2Easy.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy2Easy.DestroyedAtTime);
            }
            else
            {
            ...
            if (health3 <= 0)
            {
                ...
                sw.WriteLine("at position " + AggressiveEnemy3Easy.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy3Easy.DestroyedAtTime);
            }
            else
            {
            ...
            if (healthHQ1 <= 0)
            {
                ...
                sw.WriteLine("at position " + HQAttackingEnemy1Easy.DestroyedAtPosIsl);
                sw.WriteLine("at time " + HQAttackingEnemy1Easy.DestroyedAtPosIsl);
            }
            else
            {
                sw.WriteLine("Submarine at HQ 1 survived ");
            }

            if (healthHQ2 <= 0)
            {
                sw.WriteLine("Submarine at HQ 2 destroyed ");
                sw.WriteLine("at position " + HQAttackingEnemy2Easy.DestroyedAtPosIsl);
                sw.WriteLine("at time " + HQAttackingEnemy2Easy.DestroyedAtPosIsl);
            }
            else
            {
                sw.WriteLine("Submarine at HQ 2 survived ");
            }

            if (healthHQ3 <= 0)
            {
                sw.WriteLine("Submarine at HQ 3 destroyed ");
                sw.WriteLine("at position " + HQAttackingEnemy3Easy.DestroyedAtPosIsl);
                sw.WriteLine("at time " + HQAttackingEnemy3Easy.DestroyedAtPosIsl);
            }
            else
            {
                sw.WriteLine("Submarine at HQ 3 survived ");
            }
            if (health1 <= 0)
            {
                sw.WriteLine("Submarine at HQ 4 destroyed ");
                sw.WriteLine("at position " + HQAttackingEnemy4Easy.DestroyedAtPosIsl);
                sw.WriteLine("at time " + HQAttackingEnemy4Easy.DestroyedAtTimeIsl);
            }
            else
            {
