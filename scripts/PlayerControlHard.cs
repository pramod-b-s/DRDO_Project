...
public class PlayerControlHard : MonoBehaviour
{
    ...
    private int ctrlFlag = 0, winFlag = 0, disorientflag = 0;
    ...
    void Start()
    {
        ...
        sw = new StreamWriter("datalogHard.txt", true);
    ...
    private void FixedUpdate()
    {
        ...
        if (healthHQ3 > 0)
        {
            ...
            healthIsland3txt.text = "Enemy 4 : " + healthHQ3;
        }
        else
        {
            healthIsland3txt.text = "";
            ...
            if (Physics.Raycast(ray, out hit, maxRayDist))
            {
                ...
                if (destIsland3 == 0)
                {
                    if (hit.collider.tag == "sub_enemy_island_3" && destIsland3 == 0)
                    {
                        ...
                        if (flagIsland3 == 0)
                        {
                            warningtxt.text = "Torpedo Shot Submarine 4 !";
                            ...
                            if (healthHQ3 <= 0)
                            {
                                ...
                                destIsland3 = 1;
                                warningtxt.text = "Submarine 4 Destroyed !";
                            }
                        }
                    }
                }
		...
		*/
        ...
        if (destIsland3 == 0)
        {
            posIsland3txt.text = "Sub 4 : " + (GameObject.FindGameObjectWithTag("sub_player").transform.position -
    ...
    private void OnDestroy()
    {
        ...
        using (sw)
        {
            ...
            if (health1 <= 0)
            {
                ...
                sw.WriteLine("at position " + AggressiveEnemy1Hard.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy1Hard.DestroyedAtTime);
            }
            else
            {
            ...
            if (health2 <= 0)
            {
                ...
                sw.WriteLine("at position " + AggressiveEnemy2Hard.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy2Hard.DestroyedAtTime);
            }
            else
            {
            ...
            if (health3 <= 0)
            {
                ...
                sw.WriteLine("at position " + AggressiveEnemy3Hard.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy3Hard.DestroyedAtTime);
            }
            else
            {
            ...
            if (healthHQ3 <= 0)
            {
                sw.WriteLine("Submarine 4 destroyed ");
                sw.WriteLine("at position " + AggressiveEnemy4Hard.DestroyedAtPos);
                sw.WriteLine("at time " + AggressiveEnemy4Hard.DestroyedAtTime);
            }
            else
            {
                sw.WriteLine("Submarine 4 survived ");
            }

            if (healthHQ1 <= 0)
            {
                sw.WriteLine("Submarine at HQ 1 destroyed ");
                sw.WriteLine("at position " + HQAttackingEnemy1Hard.DestroyedAtPosIsl);
                sw.WriteLine("at time " + HQAttackingEnemy1Hard.DestroyedAtPosIsl);
            }
            else
            {
            ...
            if (healthHQ2 <= 0)
            {
                ...
                sw.WriteLine("at position " + HQAttackingEnemy2Hard.DestroyedAtPosIsl);
                sw.WriteLine("at time " + HQAttackingEnemy2Hard.DestroyedAtPosIsl);
            }
            else
            {
